...
class POUpdateDialog:
    ...
    def __init__(self, parent: tk.Tk, current_po: str, on_save_callback: Callable[[str], None], config, end_row: int):
        self.parent = parent
    ...
    def _save(self) -> None:
        ...
        confirm_msg = (
            ...
            f"{new_po}\n\n"
            f"Tất cả dòng từ {start_row} đến {self.end_row} trong cột A sẽ được cập nhật?"
        )
